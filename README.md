...
- この猫の絵は私が書いたものではなくて下記から引用したものです。 
  - https://github.com/IreneKnapp/oneko/tree/master
- この絵はXBMというアルファチャンネルが存在しないファイル形式で提供されているのでそれを下記のスクリプトでPNGに変換しています。 
  - https://github.com/anissatta/home-project/blob/main/neko/oneko2png.sh
